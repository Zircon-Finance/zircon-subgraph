...
export class Pylon__burnAsyncResult {
  value0: BigInt;
  value1: BigInt;
...
export class Pylon__getSyncReservesResult {
  value0: BigInt;
  value1: BigInt;
...
export class Pylon__initPylonResult {
  value0: BigInt;
  value1: BigInt;
...
export class Pylon extends SmartContract {
  static bind(address: Address): Pylon {
    return new Pylon("Pylon", address);
  }

  EMABlockNumber(): BigInt {
    let result = super.call("EMABlockNumber", []);

    return result[0].toBigInt();
  }

  try_EMABlockNumber(): CallResult<BigInt> {
    let result = super.tryCall("EMABlockNumber", []);
    if (result.reverted) {
  ...
  anchorKFactor(): BigInt {
    let result = super.call("anchorKFactor", []);

    return result[0].toBigInt();
  }

  try_anchorKFactor(): CallResult<BigInt> {
    let result = super.tryCall("anchorKFactor", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  burnAsync(_to: Address, _isAnchor: boolean): Pylon__burnAsyncResult {
    let result = super.call("burnAsync", [
      EthereumValue.fromAddress(_to),
      EthereumValue.fromBoolean(_isAnchor)
    ]);

    return new Pylon__burnAsyncResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_burnAsync(
    _to: Address,
    _isAnchor: boolean
  ): CallResult<Pylon__burnAsyncResult> {
    ...
    return CallResult.fromValue(
      new Pylon__burnAsyncResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

  formulaSwitch(): boolean {
    let result = super.call("formulaSwitch", []);

    return result[0].toBoolean();
  }

  try_formulaSwitch(): CallResult<boolean> {
    let result = super.tryCall("formulaSwitch", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  gammaEMA(): BigInt {
    let result = super.call("gammaEMA", []);

    return result[0].toBigInt();
  }

  try_gammaEMA(): CallResult<BigInt> {
    let result = super.tryCall("gammaEMA", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  getSyncReserves(): Pylon__getSyncReservesResult {
    let result = super.call("getSyncReserves", []);

    return new Pylon__getSyncReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_getSyncReserves(): CallResult<Pylon__getSyncReservesResult> {
    ...
    let value = result.value;
    return CallResult.fromValue(
      new Pylon__getSyncReservesResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

  initPylon(_to: Address): Pylon__initPylonResult {
    let result = super.call("initPylon", [EthereumValue.fromAddress(_to)]);

    return new Pylon__initPylonResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_initPylon(_to: Address): CallResult<Pylon__initPylonResult> {
    ...
    let value = result.value;
    return CallResult.fromValue(
      new Pylon__initPylonResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  lastRootKTranslated(): BigInt {
    let result = super.call("lastRootKTranslated", []);

    return result[0].toBigInt();
  }

  try_lastRootKTranslated(): CallResult<BigInt> {
    let result = super.tryCall("lastRootKTranslated", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  muMulDecimals(): BigInt {
    let result = super.call("muMulDecimals", []);

    return result[0].toBigInt();
  }

  try_muMulDecimals(): CallResult<BigInt> {
    let result = super.tryCall("muMulDecimals", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  strikeBlock(): BigInt {
    let result = super.call("strikeBlock", []);

    return result[0].toBigInt();
  }

  try_strikeBlock(): CallResult<BigInt> {
    let result = super.tryCall("strikeBlock", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  thisBlockEMA(): BigInt {
    let result = super.call("thisBlockEMA", []);

    return result[0].toBigInt();
  }

  try_thisBlockEMA(): CallResult<BigInt> {
    let result = super.tryCall("thisBlockEMA", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
...
export class ChangeEnergyAddressCall__Inputs {
  ...
  get _energyAddress(): Address {
    return this._call.inputValues[0].value.toAddress();
  }

  get _energyRevAddress(): Address {
...
export class InitMigratedPylonCall extends EthereumCall {
  get inputs(): InitMigratedPylonCall__Inputs {
    return new InitMigratedPylonCall__Inputs(this);
  }

  get outputs(): InitMigratedPylonCall__Outputs {
    return new InitMigratedPylonCall__Outputs(this);
  }
}

export class InitMigratedPylonCall__Inputs {
  _call: InitMigratedPylonCall;

  constructor(call: InitMigratedPylonCall) {
    this._call = call;
  }
...
export class InitMigratedPylonCall__Outputs {
  _call: InitMigratedPylonCall;
