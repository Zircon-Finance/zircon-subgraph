...
export class Pair__mintOneSideResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Pair extends SmartContract {
  ...
  burnOneSide(to: Address, isReserve0: boolean): BigInt {
    let result = super.call("burnOneSide", [
      EthereumValue.fromAddress(to),
      EthereumValue.fromBoolean(isReserve0)
    ]);

    return result[0].toBigInt();
  }

  try_burnOneSide(to: Address, isReserve0: boolean): CallResult<BigInt> {
    let result = super.tryCall("burnOneSide", [
      EthereumValue.fromAddress(to),
      EthereumValue.fromBoolean(isReserve0)
    ]);
    if (result.reverted) {
  ...
  energyRevenueAddress(): Address {
    let result = super.call("energyRevenueAddress", []);

    return result[0].toAddress();
  }

  try_energyRevenueAddress(): CallResult<Address> {
    let result = super.tryCall("energyRevenueAddress", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  mintOneSide(to: Address, isReserve0: boolean): Pair__mintOneSideResult {
    let result = super.call("mintOneSide", [
      EthereumValue.fromAddress(to),
      EthereumValue.fromBoolean(isReserve0)
    ]);

    return new Pair__mintOneSideResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_mintOneSide(
    to: Address,
    isReserve0: boolean
  ): CallResult<Pair__mintOneSideResult> {
    let result = super.tryCall("mintOneSide", [
      EthereumValue.fromAddress(to),
      EthereumValue.fromBoolean(isReserve0)
    ]);
    if (result.reverted) {
...
export class BurnOneSideCall extends EthereumCall {
  get inputs(): BurnOneSideCall__Inputs {
    return new BurnOneSideCall__Inputs(this);
  }

  get outputs(): BurnOneSideCall__Outputs {
    return new BurnOneSideCall__Outputs(this);
  }
}

export class BurnOneSideCall__Inputs {
  _call: BurnOneSideCall;

  constructor(call: BurnOneSideCall) {
    this._call = call;
  }
  ...
  get isReserve0(): boolean {
    return this._call.inputValues[1].value.toBoolean();
  }
}

export class BurnOneSideCall__Outputs {
  _call: BurnOneSideCall;
...
export class MintOneSideCall extends EthereumCall {
  get inputs(): MintOneSideCall__Inputs {
    return new MintOneSideCall__Inputs(this);
  }

  get outputs(): MintOneSideCall__Outputs {
    return new MintOneSideCall__Outputs(this);
  }
}

export class MintOneSideCall__Inputs {
  _call: MintOneSideCall;

  constructor(call: MintOneSideCall) {
    this._call = call;
  }
...
export class MintOneSideCall__Outputs {
  _call: MintOneSideCall;
...
export class PublicMintFeeCall extends EthereumCall {
  get inputs(): PublicMintFeeCall__Inputs {
    return new PublicMintFeeCall__Inputs(this);
  }

  get outputs(): PublicMintFeeCall__Outputs {
    return new PublicMintFeeCall__Outputs(this);
  }
}

export class PublicMintFeeCall__Inputs {
  _call: PublicMintFeeCall;

  constructor(call: PublicMintFeeCall) {
    this._call = call;
  }
}

export class PublicMintFeeCall__Outputs {
  _call: PublicMintFeeCall;
...
export class TryLockCall extends EthereumCall {
  get inputs(): TryLockCall__Inputs {
    return new TryLockCall__Inputs(this);
  }

  get outputs(): TryLockCall__Outputs {
    return new TryLockCall__Outputs(this);
  }
}

export class TryLockCall__Inputs {
  _call: TryLockCall;

  constructor(call: TryLockCall) {
    this._call = call;
  }
}

export class TryLockCall__Outputs {
  _call: TryLockCall;
