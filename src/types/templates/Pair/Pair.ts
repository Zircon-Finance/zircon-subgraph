...
export class SwapNoFee extends ethereum.Event {
...
export class Pair extends ethereum.SmartContract {
  ...
  burnOneSide(to: Address, isReserve0: boolean): BigInt {
    let result = super.call(
      "burnOneSide",
      "burnOneSide(address,bool):(uint256)",
      [ethereum.Value.fromAddress(to), ethereum.Value.fromBoolean(isReserve0)]
    );
  ...
  mintOneSide(to: Address, isReserve0: boolean): Pair__mintOneSideResult {
    let result = super.call(
      "mintOneSide",
      "mintOneSide(address,bool):(uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(to), ethereum.Value.fromBoolean(isReserve0)]
    );
  ...
  try_mintOneSide(
    to: Address,
    isReserve0: boolean
  ): ethereum.CallResult<Pair__mintOneSideResult> {
    let result = super.tryCall(
      "mintOneSide",
      "mintOneSide(address,bool):(uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(to), ethereum.Value.fromBoolean(isReserve0)]
...
export class BurnOneSideCall extends ethereum.Call {
...
export class MintOneSideCall extends ethereum.Call {
...
export class TryLockCall extends ethereum.Call {
