...
export class SwapNoFee extends EthereumEvent {
  get params(): SwapNoFee__Params {
    return new SwapNoFee__Params(this);
  }
}

export class SwapNoFee__Params {
  _event: SwapNoFee;

  constructor(event: SwapNoFee) {
    this._event = event;
  }
...
export class TEST extends EthereumEvent {
